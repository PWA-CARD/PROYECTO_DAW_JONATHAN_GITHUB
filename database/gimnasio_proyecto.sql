...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-01-2026 a las 18:29:12
...
(11, 'usuario', '000000000', '2000-01-01', 'usuario@gimnasio.com', 1, NULL),
(12, 'Cliente1', '000000000', '2000-01-01', 'cliente@gimnasio.com', 1, NULL);
...
('2026-01-26', 11, 2, 1, NULL),
('2026-01-26', 11, 3, 1, NULL),
('2026-01-26', 11, 8, 1, NULL);
...
INSERT INTO `usuario` (`id`, `nombre`, `email`, `password_hash`, `rol`, `idReferencia`, `avatar`, `activo`, `fechaBaja`) VALUES
(1, 'Administrador', 'admin@gimnasio.com', '1234', 'admin', NULL, NULL, 1, NULL),
(5, 'Editor', 'editor@gimnasio.com', '1234', 'editor', NULL, NULL, 1, NULL),
(6, 'Usuario demo', 'user@gimnasio.com', '1234', '', NULL, NULL, 1, NULL),
(7, 'Cliente1', 'cliente@gimnasio.com', '$2y$10$GNQhIggqgEWFY9.eM2o15.4SzNKI/TBymjQx9h3ti6GIcuUpd40pe', 'admin', 12, NULL, 1, NULL),
(8, 'admin', 'admin1@gimnasio.com', '$2y$10$hClIP7VmPdiQpGev5Y80J.0qsGNNWIM4d8c9c4rr8oXZW4vcMb.v2', 'admin', NULL, NULL, 1, NULL),
(9, 'usuario', 'usuario@gimnasio.com', '$2y$10$nCykwqLJAYsIOdjdz4kyieAC/04.WzyCsS/ftHzn9ry9Vtrn8jsni', 'cliente', 11, NULL, 1, NULL);
...
--
ALTER TABLE `cliente`
  MODIFY `idCliente` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
